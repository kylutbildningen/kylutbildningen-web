        ...
        <div className="px-8 py-10">
              ...
              <div key={label} className="flex items-center gap-3">
                <div className="flex items-center gap-1.5">
                  <div
                    ...
                    style={{
                      backgroundColor: i < 2 ? "var(--success)" : i === 2 ? "var(--frost)" : "var(--border)",
                      color: i <= 2 ? "#fff" : "var(--slate-light)",
                    }}
                  >
                    {i < 2 ? <CheckIcon /> : i + 1}
                  </div>
                  <span
                    ...
                    style={{ color: i === 2 ? "var(--slate-deep)" : "var(--slate-light)" }}
                  >
                    {label}
                  </span>
                </div>
                {i < 3 && (
                  <div
                    className="h-px w-6"
                    style={{ backgroundColor: i < 2 ? "var(--success)" : "var(--border)" }}
                  />
                )}
              </div>
            ))}
          ...
          {loading ? (
            ...
            <>
              ...
              {/* Company selection */}
              {companies.length === 0 ? (
                <div className="rounded-lg border p-6 text-center" style={{ borderColor: "var(--border)", background: "#F8F9FB" }}>
                  ...
                  <button
                    ...
                    className="px-6 py-3 text-sm font-semibold tracking-wider uppercase text-white rounded"
                  ...
                  <p className="text-xs mt-4" style={{ color: "var(--muted)" }}>
                    ...
                    <a href="mailto:info@kylutbildningen.se" className="underline" style={{ color: "#1A5EA8" }}>
                      Kontakta oss
                    </a>
                  </p>
                </div>
